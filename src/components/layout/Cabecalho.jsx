...
const Cabecalho = () => {
  ...
  Aqui, definimos no useState um valor inicial (colocando entre os parênteses do useState),
  além de desestruturar o state em uma variável (titulo) e em uma função (setTitulo) que 
  será responsável por atualizar este state/título */
